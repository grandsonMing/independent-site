<template>
	<footer class="w-screen pt-10 bg-neutral-100">
		<div
		...
		<hr />
		<div class="w-full py-10 md:flex md:mx-auto">
			<div
		...
		<div
			class="justify-end w-full px-4 py-10 mx-auto bg-neutral-900 md:flex md:py-6"
		>
